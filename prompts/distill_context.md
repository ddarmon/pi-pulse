...
feed a research agent. The user's durable profile is in
`interests.md` (attached) -- treat it as authoritative for role,
...
2. **Open questions.** Things asked but not resolved, problems hit
   but parked.
...
5. **Avoid.** One-off tangents, settled topics, areas explicitly
   marked "you were wrong" or rejected.

Rules:

- Be specific. "Sourdough cold-retard at 70% hydration" not "model architectures."
  Name the technique, release, person, or identifier.
